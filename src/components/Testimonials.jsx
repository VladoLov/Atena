...
function Testimonials() {
  return (
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex gap-5">
                ...
                <div className="flex justify-center gap-0.5 text-green-500">
                  <button className="bg-crimson-500 text-black px-4 py-2 rounded">
                    Contact us
                  </button>
                </div>
              </div>
    ...
    /* <section className="bg-crimson-50 w-full lg:max-w-screen-xl lg:w-auto mx-auto  flex items-center justify-center">
      <div className=" max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          ...
          <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8 ">
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex gap-5">
                ...
                <div className="flex justify-center gap-0.5 text-green-500">
                  <Button className="bg-crimson-500 text-black">
                    Contact us
                  </Button>
                </div>
              </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
          <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-4 text-gray-700">
              Working with ATENA has significantly increased our research
          ...
          <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-4 text-gray-700">
              The future is today, due to ATENA, since the moment for innovative
              and quick research development has arrived.
            </p>
          </blockquote>
