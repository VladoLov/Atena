...
export async function generateMetadata() {
  ...
  return {
    title: t("metabolicMitochondrialDisordersPage.title"), // Specific title for this page
    description: t("metabolicMitochondrialDisordersPage.description"),
    keywords: t("metabolicMitochondrialDisordersPage.keywords"),
  };
}

function MetabolicMitochondrialDisorders() {
  const t = useTranslations("MetabolicMitochondrialDisorders");
  return (
    <div className="flex flex-col  justify-center items-center w-full">
      <main className="w-full ">
        ...
        <section className="min-w-max z-[-1] relative h-[300px] md:h-[400px] lg:h-[500px]">
          <Image
            src="/metabolic-and-mitochondrial.webp?height=500&width=1000"
