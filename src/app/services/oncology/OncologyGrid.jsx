...
const oncologyServices = [
  {
    ...
    description:
      "Tumor Profiling NGS plays a vital role in sequencing tumor DNA. This process helps identify mutations, gene fusions, and other genetic changes that contribute to cancer growth. Tumor profiling allows doctors to create personalized treatment plans, a key part of precision oncology.",
  ...
  },
  {
    ...
    image: "/oncology/liquid-biopsies.jpg?height=400&width=600",
  },
  {
    ...
    image: "/oncology/cancer-screening.jpeg?height=400&width=600",
  },
  {
    ...
    image: "/oncology/drug-resistance.jpg?height=400&width=600",
  },
];
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid gap-8">
        <div className="grid grid-cols-1">
          <p className="mb-4">
            Next-generation sequencing (NGS) is transforming oncology by
            offering a deeper understanding of cancer at the genetic level. With
            NGS, specific mutations can be identified which drive cancer growth,
            allowing for targeted treatments that are potentially more effective
            and less invasive. Choosing NGS means giving patients the best
            chance for success with precision medicine that’s tailored to their
            unique genetic profile. Empower your oncology practice with
            cutting-edge technology that delivers real, life-changing results
            for your patients.
          </p>
        </div>
