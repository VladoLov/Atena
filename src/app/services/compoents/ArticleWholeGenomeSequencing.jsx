...
function ArticleWholeGenomeSequencing() {
  return (
    <article className="overflow-hidden bg-gray-50 sm:grid sm:grid-cols-2 max-w-screen-xl gap-5 mx-auto my-12">
      <div className="none">
        ...
        <p>
          ...
          determining the complete DNA sequence of an organism&apos;s genome at
          a single time. This includes sequencing all of an individual&apos;s
          genetic material, both coding (genes) and non-coding regions. WGS
          provides comprehensive data about the genetic blueprint of an
          organism, which can be used for various applications in research,
      ...
      <div className="col-span-2 mt-12 py-6">
        <div className="flex justify-center items-center">
        ...
        <div className="flex flex-col gap-2 ">
          ...
          <ul className="list-disc tracking-wide leading-6">
            ...
            <li>
              ...
              fragmented into smaller pieces, and special adapters are attached
              to the ends of these fragments to prepare them for sequencing.
            </li>
            <li>
              <strong>Sequencing:</strong> Modern sequencing technologies (e.g.,
              Illumina, PacBio, or Oxford Nanopore) read the sequence of DNA
              bases (adenine, guanine, cytosine, and thymine) from the
              fragments.
            </li>
            <li>
              <strong>Assembly and Alignment:</strong> The short sequences
              produced are aligned and assembled computationally to reconstruct
              the entire genome.
            </li>
          </ul>
          ...
          <ul className="list-disc tracking-wide leading-6 ">
            ...
            <li>
              ...
              the evolutionary history of species, allowing researchers to track
          ...
          <ul className="list-disc tracking-wide leading-6">
            ...
            <li>
              <strong>Disease Diagnosis:</strong> It helps in diagnosing genetic
              disorders by identifying even rare mutations that other methods
              might miss.
            </li>
            <li>
              <strong>Research Advancement:</strong> WGS facilitates advances in
              genetics and genomics by uncovering the molecular basis of various
              traits and diseases.
            </li>
          </ul>
          ...
          <ul className="list-disc tracking-wide leading-6">
            ...
            <li>
              ...
              variants have known clinical significance, so interpreting results
              can be complex.
            </li>
            <li>
          ...
          <ul className="list-disc tracking-wide leading-6">
            <li>
              <strong>Targeted Sequencing:</strong> Focuses on specific regions
              of the genome, like the exome (protein-coding genes). WGS covers
              the entire genome, including regulatory regions and non-coding
              DNA.
            </li>
            <li>
              <strong>Genotyping:</strong> Detects predefined genetic variants;
              WGS discovers both known and novel variants across the entire
              genome.
            </li>
            <li>
